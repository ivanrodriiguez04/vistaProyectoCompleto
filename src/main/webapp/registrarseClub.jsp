...
<body>
    <div class="container" style="max-width: 400px; margin-top: 50px;">
        ...
        <form id="registerForm">
            <!-- Correo -->
            <div class="mb-3">
                <input type="email" id="registerEmail" class="form-control" placeholder="Insertar correo" required>
            </div>

            <!-- Nombre de usuario -->
            <div class="mb-3">
                <input type="text" id="registerUsername" class="form-control" placeholder="Nombre club" required>
            </div>

            <!-- Contraseña -->
            <div class="mb-3">
                <input type="password" id="registerPassword" class="form-control" placeholder="Introduce la contraseña" required>
            </div>
