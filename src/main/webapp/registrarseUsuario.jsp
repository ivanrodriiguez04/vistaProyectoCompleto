...
<body>
    <div class="container" style="max-width: 400px; margin-top: 50px;">
        ...
        <form id="registerForm">
            ...
            <!-- Nombre de usuario -->
            <div class="mb-3">
                <input type="text" id="registerUsername" class="form-control" placeholder="Nombre usuario" required>
            </div>

            <!-- Contraseña -->
            <div class="mb-3">
                <input type="password" id="registerPassword" class="form-control" placeholder="Introduce la contraseña"
                    required>
            </div>
